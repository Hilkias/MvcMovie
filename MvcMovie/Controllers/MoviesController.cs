...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            return View(await movies.OrderBy(m => m.ReleaseDate).Include(m => m.Genre).ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieId,Title,ReleaseDate,GenreId,Price,Image")] Movie movie)
        {
            if (id != movie.MovieId)
            {
                return NotFound();
